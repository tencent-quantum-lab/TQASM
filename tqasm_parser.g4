...
stdgate
    ...
    | PHASE LPAREN explist RPAREN argument SEMI // not support for now 
    ...
    | ISWAP LPAREN explist RPAREN argument argument SEMI // not support for now
    | UNITARY LPAREN explist RPAREN argument SEMI // not support for now
    ;
